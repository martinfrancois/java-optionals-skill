...
if [[ "$*" == *"--head release-please--branches--main--components--java-optionals"* ]]; then
...
run_case \
  "release-pr-json" \
  '{"title":"chore: release 1.2.3","headBranchName":"release-please--branches--main--components--java-optionals"}' \
  "" \
  "" \
  "true" \
  "release-please--branches--main--components--java-optionals"
